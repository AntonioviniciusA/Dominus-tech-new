...
export function ProductPageContent({
  ...
  const productImages = [product.image, ...extraImages]; // Você pode adicionar mais imagens aqui se disponível
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-red-600 font-semibold text-sm">
                Últimas unidades (1 unidade disponível)
              </span>
            </div>
            ...
            <Card className="bg-gray-50 border-0">
              <CardContent className="p-4 space-y-2">
                <p className="text-lg font-bold text-gray-900">
                  10x de R$ {installmentPrice.replace(".", ",")}
                </p>
                <p className="text-xs text-gray-600">
                  (com juros de 2.19% a.m.)
                </p>
                <Link
                  href="#"
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center border border-gray-300 rounded-lg w-fit">
                ...
                <span className="px-6 py-2 font-semibold text-lg text-gray-900">
                  {quantity}
                </span>
                <button
        ...
        <DialogContent className="bg-white">
          ...
          <div className="space-y-4">
            <p className="text-gray-800">
              Para continuar com a compra, você precisa aceitar os cookies para
              que possamos rastrear dados de navegação.
            </p>
          </div>
