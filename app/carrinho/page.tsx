      ...
      const itemsText = cart
        .map(
          (item) =>
            `*${item.product.name}*\n Quantidade: ${
              item.quantity
            }\n Preço: R$ ${item.product.price.toFixed(2).replace(".", ",")}\n `
        )
        .join("\n");
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-12">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-gray-800 hover:text-green-600 mb-8"
          >
            ...
            <Card className="bg-white sticky top-8">
              <CardContent className="p-6 space-y-4">
                ...
                <Button
                  onClick={() => clearCart()}
                  variant="outline"
                  className="w-full text-gray-900 bg-red-600"
                >
                  Limpar Carrinho
                </Button>
